                ...
                <table class="table-auto self-auto" align="center">
                    <thead>
                        <tr>
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{{ $item_detalhe['produto_id']; }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{{ $item_detalhe['comprimento']; }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{{ $item_detalhe['largura']; }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{{ $item_detalhe['altura']; }}</td>
                        </tr>
                        <tr>
